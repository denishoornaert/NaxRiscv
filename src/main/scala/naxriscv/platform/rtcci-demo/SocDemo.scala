...
class SocDemo(cpuCount : Int, coreMaxTransactions : Int = 2, downPendingMax : Int = 4, probeCount : Int = 1, asic : Boolean = false, xlen : Int = 32) extends Component {
  ...
  // hub.parameter.aBufferCount = cpuCount*coreMaxTransactions*2
  hub.parameter.downPendingMax = downPendingMax // cpuCount*coreMaxTransactions*2 // TODO: check if read and write accounted similarly in the hub?
  ...
  // Look if StreamPipe.NONE removes X component
